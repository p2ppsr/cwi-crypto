 ...
 * 
 * The ciphertext string is an encoded Uint8Array (created with 
 * encodeUint8AsString), where the first 32 bytes of the array contain the 
 * initialization vector and the rest is the AES-GCM ciphertext. 
 * 
 * The key is a Uint8Array (encoded as a string) containing the 32 bytes of 
 * AES-GCM key data.
 * 
 * The plaintext is whatever we want to encrypt represented as a string. 
 * Support for encrypting and decrypting Uint8Arrays will be added in a future 
 * version.
 * 
 ...
 * function will execute and validate the vectors.
 */
export default [
  {
